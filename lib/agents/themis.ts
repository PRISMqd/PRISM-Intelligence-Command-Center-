// Agent EA-26: Themis — 
// Spec source: PRISM Canon Book I, Agent 26: Themis — Equity Governance and Structural Accountability
//
...
export const THEMIS_KNOWLEDGE = [
  'CA-003 (Constitutional Article III: Epistemic Justice and Structural Harm Recognition, full text)',
  'relationships (power asymmetry mapping)',
  'decisions (beneficiary accountability fields)',
  '7 subagents: Accountability, Cartographer (power mapping), Memory (historical harm documentation), Calibration (equity calibration audit), Participation (structural participation assessment), Dissemination (anti-extractive compliance), Mirror (self-audit)',
]
